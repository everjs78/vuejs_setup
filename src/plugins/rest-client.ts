...
export default class RestClient {
  ...
  public async get<ItemType = any>(endpoint: string, queryParams?: JsonSerializable, config?: RequestConfig): Promise<ItemType> {
    return this.formatResponse<ItemType>(
      await this.getRaw<ItemType>(endpoint, queryParams, config),
    );
  }
  // tslint:disable-next-line: max-line-length
  public async post<ItemType = any>(endpoint: string, data?: JsonSerializable | FormData, config?: RequestConfig): Promise<ItemType> {
    return this.formatResponse<ItemType>(
      await this.postRaw<ItemType>(endpoint, data, config),
    );
  }
  // tslint:disable-next-line: max-line-length
  public async put<ItemType = any>(endpoint: string, data?: JsonSerializable | FormData, config?: RequestConfig): Promise<ItemType> {
    return this.formatResponse<ItemType>(
      await this.putRaw<ItemType>(endpoint, data, config),
    );
  }
  public async delete<ItemType = any>(endpoint: string, config?: RequestConfig): Promise<ItemType> {
    return this.formatResponse<ItemType>(
      await this.deleteRaw<ItemType>(endpoint, config),
    );
  }
  // tslint:disable-next-line: max-line-length
  public async getRaw<ItemType = any>(endpoint: string, queryParams?: JsonSerializable, config?: RequestConfig): Promise<AxiosResponse> {
    return this.myAxios.get<ItemType>(this.urlFor(endpoint), { ...this.configFor(config), params: queryParams });
  }
  // tslint:disable-next-line: max-line-length
  public async postRaw<ItemType = any>(endpoint: string, data?: JsonSerializable | FormData, config?: RequestConfig): Promise<AxiosResponse> {
    return this.myAxios.post<ItemType>(this.urlFor(endpoint), data, this.configFor(config));
  }
  // tslint:disable-next-line: max-line-length
  public async putRaw<ItemType = any>(endpoint: string, data?: JsonSerializable | FormData, config?: RequestConfig): Promise<AxiosResponse> {
